...
featured-image: /assets/images/posts/cmb/report_2/cmb_map_planck_2018_moll.webp
...
## Notes
All my work can be accessed on my <a href="">GitHub repository</a> of the course. Final project codes are situated in the `project_codes` folder, while my presentation slides and presentation scripts can be found under the `docs` folder.
