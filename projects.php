...
<html lang="en">
  <head>
    ...
    <meta
      name="description"           
      content="List of my projects which I want to share.">
  ...
  <body>
    ...
    <div id="page-wrapper">
      ...
      <div class="index-content">
        <div class="post">
          <a href="./projects/project_1/project_1.html">
            <hPost>Project 1. - Wave function of Hydrogen</hPost>
          </a>
          <p class="postDesc">
            In this project I've recreated the well-known textbook visualization of the wave function of the simple hydrogene atom.
            Let's dive into the details of building an arbitrary atom's wave function numerically!
          </p>
          <div class="postimg-container">
            <a href="./projects/project_1/project_1.html">
              <img src="./projects/project_1/images/orbit_n_3-l_2-m_1.png" alt="Missing post image"></img>
            </a>
          </div>
        </div>
        <div class="post">
          <hPost>Second project</hPost>
          <p>Some description...</p>
          <img src='' class="postimg" alt="Missing post image"></img>
        </div>
      </div>
      <div class="footer">
        <p>
